...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_HelloWorldServer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 28, 12)
    ...
    "HelloWorldServer\0readyRead\0\0disconnected\0"
};
...
void HelloWorldServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        HelloWorldServer *_t = static_cast<HelloWorldServer *>(_o);
        switch (_id) {
...
const QMetaObject HelloWorldServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_HelloWorldServer.data,
      qt_meta_data_HelloWorldServer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HelloWorldServer.stringdata))
        return static_cast<void*>(const_cast< HelloWorldServer*>(this));
